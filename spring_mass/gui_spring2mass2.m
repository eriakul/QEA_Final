function varargout = gui_spring2mass2(varargin)
% GUI_SPRING2MASS2 MATLAB code for gui_spring2mass2.fig
% Simulates 2 masses connected by 2 springs to one wall
% How to use the GUI:
%    - Set desired parameters for 2 masses and 2 springs
...
% Last Modified by GUIDE v2.5 11-Nov-2014 14:01:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_spring2mass2_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_spring2mass2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_spring2mass2 is made visible.
function gui_spring2mass2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_spring2mass2 (see VARARGIN)
global x1 x2 v1 v2 
global m1 m2 k1 k2 
global stop
stop=1;
...
axis([0 num_masses+l1+l2+1.5 -1 1]);axis equal;axis off;set(gcf,'Color','w')
line([0 0],[-0.5 1],'Color','k'); hold on;
%line([num_masses+l1+l2 num_masses+l1+l2],[-0.5 1],'Color','k');
line([0 num_masses+l1+l2+1.5], [-0.5 -0.5],'Color','k');
...
handles.spring1=spring1;handles.spring2=spring2;
handles.l1=l1;handles.l2=l2;
handles.eigenvectors=eigenvectors;

% Choose default command line output for gui_spring2mass2
...
function varargout = gui_spring2mass2_OutputFcn(hObject, eventdata, handles) 
...
spring1=handles.spring1;spring2=handles.spring2;
l1=handles.l1;l2=handles.l2;
...
for i=1:intmax
    ...
    %fprintf('%g %f %f %f \n',i,x1,x2,x3);
    [t,y] = ode45(@(t,y) masses(t,y,m1,m2,k1,k2),...
                                               [0,dt],[x1,v1,x2,v2]);
...
function dy=masses(~,y,m1,m2,k1,k2)
dy=zeros(4,1);
dy(1)=y(2);
